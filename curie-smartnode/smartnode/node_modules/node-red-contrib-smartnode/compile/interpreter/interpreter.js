module.exports = function(RED) {
    function interpreterNode(config) {
        ...
        var flowsFile = './curie-flows.json';
        //var flowsFile = '/Users/guozhong/.node-red/curie-flows.json';
        ...
        //var inoFile = '/Users/guozhong/nodejs/curie-smartnode/Arduino.app/Ccode_for_curie/'+fileName;
        //var inoFile = path.join(__dirname)+'../../../../../../Arduino.app/Ccode_for_curie/'+fileName;
        var inoFile = './../Arduino.app/Ccode_for_curie/'+fileName;
        var batfileName = 'BuildCurieSn.bat';
        //var batfilePath = path.join(__dirname)+'../../../../../../Arduino.app/';
        //var batfilePath = '/Users/guozhong/nodejs/curie-smartnode/Arduino.app/';
        var batfilePath = './../Arduino.app/';

        /*
        var batfileName = 'BuildCurieSn.bat';
        if (scriptBat == "Neurons"){
            batfileName = 'BuildCurieSn-Neurons.bat';
        }
        else if (scriptBat == "CurieIMU"){
            batfileName = 'BuildCurieSn-CurieIMU1.bat';
        }
        else if (scriptBat == "CurieNeuronsIMU"){
            batfileName = 'BuildCurieSn-CurieNeuronsIMU.bat';
        }
        else if (scriptBat == "Servo"){
            batfileName = 'BuildCurieSn-Servo.bat';
        }
        ...
        */
        ...
        function func(data,port) {
            //stty -f /dev/cu.usbmodemFD121 ispeed 1200 ospeed 1200 cs8
            var index = data.indexOf('ispeed 1200 ospeed 1200 cs8');
            var index2 = data.indexOf('OutputCurieSn/Ccode_for_curie.ino.bin /dev/cu.usbmodemFD0');
            if (index != -1){
                var char_txt = 'stty -f';
                var length = char_txt.length;
                var index_1 = data.indexOf('stty -f');
                var index_2 = data.indexOf('ispeed');
